...
def train(X, Y, nn_architecture, epochs, learning_rate):
    ...
    for i in range(epochs):
        params_values, cost_history, accuracy_history, _ = train_once(X, Y, nn_architecture, learning_rate, params_values, cost_history, accuracy_history)
...
class AnimateTrainer:
    ...
    def __call__(self):
        self.counter -= 10
        for i in range(10):
            self.params_values, self.cost_history, self.accuracy_history, Y_hat = train_once(self.X, self.Y, self.nn_architecture, self.learning_rate, self.params_values, self.cost_history, self.accuracy_history)
